...
class Home:
	...
	def app(self):
		...
		- 🏆 Project Management Project on Coursera - Разработка плана реализации проекта [Модернизации Тепловой Электростанции](docs/project.docx) с точки зрения менеджмента
