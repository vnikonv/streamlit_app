...
class Home:
	...
	def app(self):
		...
		<li>- 🏆 Project Management Project on Coursera - Разработка плана реализации проекта <a href="/docs/project.docx" download="project.docx">Модернизации Тепловой Электростанции</a> с точки зрения менеджмента</li>
