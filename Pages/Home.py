...
class Home:
	...
	def app(self):
		...
		<li>- 🏆 Project Management Project on Coursera - Разработка плана реализации проекта <a href="https://github.com/vnikonv/streamlit_app/blob/908d2ec65bf5863c4dda7db5471dbf17346caa96/Pages/project.docx" download="project.docx">Модернизации Тепловой Электростанции</a> с точки зрения менеджмента</li>
